...
class ThumbnailPickerTab(ctk.CTkFrame):
    ...
    def _build_ui(self):
        ...
        act.grid(row=4, column=0, sticky="ew", padx=6, pady=(0, 6))
        act.grid_columnconfigure(0, weight=2)
        act.grid_columnconfigure(1, weight=0)
        act.grid_columnconfigure(2, weight=0)

        self.btn_set = ctk.CTkButton(
            act, text="\u2713  Set This Frame as Thumbnail",
            height=44, font=ctk.CTkFont(family=UI_FONT, size=14, weight="bold"),
            fg_color=GREEN, hover_color="#277f39",
            state="disabled", command=self._set_thumbnail)
        self.btn_set.grid(row=0, column=0, sticky="ew", padx=(0, 8))

        self.btn_export_current = ctk.CTkButton(
            act, text="\U0001f5bc  Current", width=118, height=40,
        ...
        self.btn_export_proposed = ctk.CTkButton(
            act, text="\U0001f5bc  Proposed", width=126, height=40,
            font=ctk.CTkFont(family=UI_FONT, size=12),
            fg_color=BLUE_DARK, hover_color=BLUE_HOVER,
            border_color="#3b6595", border_width=1,
