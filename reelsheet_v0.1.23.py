...
class ThumbnailPickerTab(ctk.CTkFrame):
    ...
    def _build_ui(self):
        ...
        control_wrap.grid(row=3, column=0, pady=(0, 6))

        # Transport + volume
        tr = tk.Frame(control_wrap, bg=BG)
        tr.pack(fill="x")

        # Volume: icon + slider
        vol_group = tk.Frame(tr, bg=BG)
        ...
        # Transport buttons
        controls = tk.Frame(tr, bg=BG)
        controls.grid(row=0, column=1, padx=(138, 0))
        col = 0
        transport_defs = [
