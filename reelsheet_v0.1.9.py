...
class ThumbnailPickerTab(ctk.CTkFrame):
    ...
    def _build_ui(self):
        ...
        # ── Outer PanedWindow: file list | content ────────────
        ...
        # ── Inner PanedWindow: thumbnail col | video ──────────
    ...
    def _restore_sash_positions(self):
        try:
            self._outer_pane.sash_place(0, self._prefs.get("sash_outer", 240), 0)
        except Exception:
            pass
        try:
            self._inner_pane.sash_place(0, self._prefs.get("sash_inner", 200), 0)
        except Exception:
            pass
